...
public class BadConsequence {
    ...
    int getTVisible() { return nVisibleTreasures; }
    
    int getTHidden() { return nHiddenTreasures; }
    
    boolean getDeath() { return death; }
    
    void setDeath(boolean death){ this.death = death; }
    
    ArrayList<TreasureKind> getSpecificHiddenTreasures() { return specificHiddenTreasures; }
